...
public class Builder : ContentBuilder
{
    public override IContentCollection GetContentCollection()
    {
        ...
        */
        ...
        //Include all png files within subfolders in the Textures folder
        contentCollection.Include<WildcardRule>("Textures/*/*.png");
        //Include all fonts inside the Fonts folder
        ...
        //Include all sound files in the Sounds folder, including subdirectories
        contentCollection.IncludeCopy<WildcardRule>("Sounds/*.ogg");
        contentCollection.IncludeCopy<WildcardRule>("Sounds/*/*.ogg");
