//Code for Custom/SliderGlow (Container)
...
partial class SliderGlow : global::Gum.Forms.Controls.Slider
{
    ...
    public static void RegisterRuntimeType()
    {
        var template = new global::Gum.Forms.VisualTemplate((vm, createForms) =>
        {
            ...
            var element = ObjectFinder.Self.GetElementSave("Custom/SliderGlow") ?? throw new System.InvalidOperationException("Could not find an element named Custom/SliderGlow - did you forget to load a Gum project?");
            element.SetGraphicalUiElement(visual, RenderingLibrary.SystemManagers.Default);
            if(createForms) visual.FormsControlAsObject = new SliderGlow(visual);
            return visual;
        });
        global::Gum.Forms.Controls.FrameworkElement.DefaultFormsTemplates[typeof(SliderGlow)] = template;
        ElementSaveExtensions.RegisterGueInstantiation("Custom/SliderGlow", () => 
        {
    ...
    public SliderGlow(InteractiveGue visual) : base(visual)
    {
    }
    public SliderGlow()
    {
